    ...
    'withworks_billing_strategy' => [
        ...
        'test' => [
            ...
            'map'     => [
                ...
                '10|차상위경감' => null, // 짝이 없다 — 공단 100% 줄을 만들어야 한다
                '10|기초'       => null, // 지자체(시군구청) 계정이 없다 — 위드웍스가 정할 일
                '10|산재'       => 133,  // 전자세금계산서(100%) — 환자 100
                '10|자동차보험' => null, // 우리 쪽 비율이 아직 확인중
                '20|'           => 137,  // 현금영수증(100%) — 환자 100 · 세금계산서 없음
            ],
        ],
         ...
         * 위드웍스 (운영) — 아직 확인하지 못했다.
         *
         * id 는 서버마다 다르므로 데모웍스 값을 그대로 옮기면 엉뚱한 줄을 가리킨다.
         * 비워 두면 저쪽이 제 기본값으로 갈아 끼운다 — 지금과 같은 자리다.
         */
        'production' => [
            'default' => null,
            'map'     => [],
