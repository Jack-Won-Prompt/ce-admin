    ...
    'withworks_billing_strategy' => [
        ...
        'test' => [
            ...
            'map'     => [
                ...
                /* 지자체 기초(100%) — 246(지자체 직접청구)을 지우고 이것을 세웠다.
                   다만 상세 줄이 아직 비어 있다 — 비율 0 · 세금계산서 NULL · 청구 대상 없음.
                   이름과 비고는 「지자체 100% · 세금계산서 100%」이라 적혀 있으니, 저쪽이
                   그 줄을 채우면 우리가 손대지 않아도 동작이 바뀜다. 바뀌는 날 확인할 것. */
                '10|기초'       => 249,  // 지자체 기초(100%)
                /* 산재 현금영수증(100%) — 133(전자세금계산서 100%)에서 옮겼다.
                   산재가 세금계산서가 아니라 현금영수증이 된 까닭이다(2026-08-31).
                   249 와 마찬가지로 상세 줄이 아직 비어 있다 — 비율 0 · 세계 NULL. */
