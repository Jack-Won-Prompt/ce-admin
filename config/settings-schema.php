    ...
    'popbill' => [
        ...
        'fields' => [
            ...
            'webhook_urls' => [
                ...
                'source' => 'webhook_urls',
                'width'  => 3,
                'help'   => '팝빌 사이트에 갈래마다 등록해야 전송 결과가 저절로 들어옵니다. '
                          . '주소에 든 긴 글자가 열쇠입니다 — 밖으로 내보이지 마십시오. '
                          . '등록 전에는 팩스가 「전송중」에 멈춰 있고, 사람이 「대기건 동기화」를 눌러야 맞춰집니다.',
            ],
            ...
            'webhook_key_required' => [
                'label' => '열쇠 확인',
                'type'  => 'bool',
                'help'  => '켜면 위 주소로 온 것만 받습니다. **팝빌에 새 주소를 등록한 뒤에** 켜십시오 — '
                         . '먼저 켜면 그 사이에 오는 전송결과를 놓칩니다.',
            ],
    ...
    'toss' => [
        ...
        'fields' => [
            ...
            'webhook_urls' => [
                ...
                'source' => 'webhook_urls',
                'width'  => 3,
                'help'   => '토스 개발자센터의 웹훅 주소를 이 값으로 바꾸면 열쇠가 함께 옵니다. '
                          . '주소에 든 긴 글자가 열쇠입니다 — 밖으로 내보이지 마십시오.',
            ],
            'webhook_key_required' => [
                'label' => '열쇠 확인',
                'type'  => 'bool',
                'help'  => '켜면 위 주소로 온 것만 받습니다. **토스에 새 주소를 등록한 뒤에** 켜십시오 — '
                         . '먼저 켜면 그 사이에 들어온 가상계좌 입금을 놓칩니다.',
            ],
