...
return [
    ...
    */
    ...
    /*
     * 본인확인을 NICE 에 묻지 않고 통과시킬지.
     *
     * 화면을 처음부터 끝까지 훑어 보는 시험에서는 같은 휴대폰으로 본인확인을 스무 번
     * 하게 된다 — 사람 손이 스무 번 필요하고, NICE 쪽에는 쓰지도 않을 인증이 스무 건
     * 쌓인다. 켜 두면 서명 화면이 「확인됨」으로 넘어간다. 기본값은 꺼짐이다.
     */
    'simulate' => (bool) env('NICE_SIMULATE', false),
