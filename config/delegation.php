...
return [
    ...
    */
    'fields' => [
        ...
        /* 위임일 — 서명란 바로 위의 「     년     월     일」 줄이다. 양식에 인쇄된
           글자와 겹치지 않게 그 사이사이에 적는다. 서명한 날이 곧 위임한 날이라
           위임기간 시작일과 같은 날짜를 쓴다.
           아래 x·y 는 첫 값일 뿐이다 — 종이마다 조금씩 달라, 설정 화면(위임장 설정 ▸
           글자 항목 위치)에서 한 번 맞춰 두면 그 값이 이긴다. */
        /* 서명란 바로 위의 「년 월 일」 줄이다. 예전 좌표(96/116/132, y=259)는 문장
           한가운데에 끼어 「…청구에 관한 2026 9 8 사항을 위와 같이 위임합니다」로
           읽혔다. 원본 서식의 날짜 자리로 옮긴다(2026-09-08). */
        'sign_date_y'      => ['label' => '위임일 년',            'x' => 151, 'y' => 270, 'size' => 8],
        'sign_date_m'      => ['label' => '위임일 월',            'x' => 167, 'y' => 270, 'size' => 8],
        'sign_date_d'      => ['label' => '위임일 일',            'x' => 181, 'y' => 270, 'size' => 8],
