...
meta = [
    ...
    ('작성일', '2026-09-07'),
    ('작성자', 'CE Admin 개발팀'),
    ('총 테스트 케이스', '20건 (TC-001 ~ TC-019, TC-013a 포함)'),
...
TCS = [
 ...
 ('TC-017','정산','주문 확정 / 입금 확인','TC-015 완료',
  '청구ㆍ회계 › 정산/회계','-',[
   (1,'해당 주문의 결제수단을 선택한다','결제수단: 링크페이',
    ...
    '[본인부담 있음] 「링크페이으로 81,000원 입금 확인했습니다」\n[본인부담 0원] 「본인부담금이 없는 건입니다 — 주문을 확정했습니다」\n공통: ① 세금계산서 TI20260907000243 발행 ② 거래명세서 PDF 생성 ③ 위드웍스 S2609070004 확정 ④ 현금영수증은 「청구전략에 없음」으로 제외',
    '화면/33_정산회계-목록.png\n화면/34_입금확인-뒤.png'),
 ]),
 ...
 ('TC-019','검증','목록 항목 검증 (판매현황 연계)','TC-015 완료',
  'Finance / 주문 관리','-',[
...
caps = [
 ...
 ('35_팩스발송-창.png','TC-013a','팝오버','공단 신규/재등록 서류 팩스 — 수신처·전송 서류'),
 ('36_팩스발송-결과.png','TC-013a','팝오버','공단 신규/재등록 서류 팩스 — 발송 결과'),
 ('26_주문제품-빈줄.png','TC-014','CE Admin','주문 제품 탭 초기 상태'),
 ('27_제품조회-팝업.png','TC-014','팝업','제품 조회 — CH14 Male'),
 ('28_주문제품-채움.png','TC-014','CE Admin','제품 선택 후 금액 자동 배분'),
 ('29_주문제품-저장.png','TC-014','CE Admin','주문 제품 저장 완료'),
 ('30_주문생성및연계.png','TC-015','CE Admin','주문 생성 및 위드웍스 연계 결과'),
 ('31_ww_판매주문-화면.png','TC-016','위드웍스','판매 주문 조회 화면'),
 ('32_ww_판매주문-조회결과.png','TC-016','위드웍스','판매주문 S2609070004 조회 결과'),
 ('33_정산회계-목록.png','TC-017','CE Admin','정산/회계 목록'),
 ('34_입금확인-뒤.png','TC-017','CE Admin','주문 확정 / 입금 확인 후 상태'),
]
