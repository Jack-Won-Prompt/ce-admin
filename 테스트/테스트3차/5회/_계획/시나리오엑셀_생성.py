...
c['B5'] = 'CASE-01   |   End-to-End 통합 테스트   |   TC-001 ~ TC-020'
...
TCS = [
 ...
 ('TC-018','연계','위드웍스 판매주문 확정 확인','TC-017 완료',
  '[위드웍스] 주문 관리 › 판매 주문','-',[
   (1,'입금 확인(주문 확정)이 창고까지 닿았는지 확인한다','판매번호: S2609070004\n판매상태: 등록·승인·확정·거절 모두 선택','［검색］ → 행 더블클릭 → [상세 목록] 탭',
...
caps = [
 ...
 ('37_ww_판매주문-확정.png','TC-018','위드웍스','판매주문 상세 — 판매상태 확정'),
]
