...
<div class="ti-layout fill-rest fill-col">
  ...
  <div class="ds-grid-card">
    ...
    <div class="pnl-tabs titab-bar">
      <button type="button" class="pnl-tab titab active" data-tab="hist" onclick="tiTab('hist')"><i class="fa-solid fa-list"></i> 발행 내역<span class="pnl-tab-cnt">(총 <b id="taxTotalCount">0</b>건)</span></button>
      ...
      <div class="form-section">
        ...
        <div class="form-grid-2">
          ...
          <div class="form-row">
            ...
            <input data-phone id="er-tel" class="form-input" type="text" placeholder="전화번호">
          </div>
          <div class="form-row">
