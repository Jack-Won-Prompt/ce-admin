...
<form method="GET" action="{{ route('webhooks.logs') }}" class="ds-filter-card">
  ...
  <div class="ds-filter-actions">
    <a href="{{ route('webhooks.logs') }}" class="ds-btn">초기화</a>
    <button type="submit" class="ds-btn ds-btn-primary">검색</button>
    <a href="{{ route('webhooks.index') }}" class="ds-btn">웹훅 관리</a>
...
<div class="ds-grid-section">
  <div class="ds-grid-card">
    <div class="pnl-tabs">
      <span class="pnl-tab active"><i class="fa-solid fa-clock-rotate-left"></i> 오간 기록
        <span class="pnl-tab-cnt">(총 {{ $counts['all'] }}건)</span>
      </span>
...
window.HELP_TOUR_STEPS = [
  { selector: '#wlGrid', title: '오간 기록', body: '주고받은 알림이 한 줄씩 남습니다. 줄을 <b>더블클릭</b>하면 주고받은 값을 그대로 봅니다.' },
  { selector: '.ds-filter-fields', title: '골라 보기', body: '기간ㆍ구분ㆍ방향ㆍ성공 여부로 좁힙니다. 주문번호로도 찾을 수 있습니다.' },
];
</script>
@endpush
