...
window.HELP_TOUR_STEPS = [
  ...
  { selector: '#orderGrid', title: '주문 목록', body: '각 행에서 주문번호·이름·위드웍스 판매번호·배송 상태를 확인합니다. 행을 클릭하면 주문 상세로 이동합니다.' },
];
</script>
@endpush
...
<div class="help-section">
  ...
  <div class="help-item">
    ...
    <div class="help-item-text"><strong>위드웍스 판매번호</strong>위드웍스가 채번한 판매주문 번호입니다. 목록에서 바로 확인합니다.</div>
  </div>
  <div class="help-item">
    ...
    <table>
      <thead>
        <tr>
          ...
          <th>주문유형</th>
          <th>상태</th>
          <th style="text-align:center;min-width:140px;">위드웍스 판매번호</th>
          <th>생성일</th>
          <th></th>
        </tr>
      </thead>
