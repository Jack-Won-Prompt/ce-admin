...
<form method="GET" action="{{ route('sample-orders.index') }}" class="ds-filter-card">
  <div class="ds-filter-fields">
    ...
    <div class="ds-filter-field span-2">
      ...
      <input type="text" name="q" value="{{ request('q') }}" class="form-control"
             placeholder="샘플번호ㆍ고객ㆍ받는 사람ㆍ위드웍스 판매번호">
    </div>
    <div class="ds-filter-field span-2">
  ...
  <div class="ds-filter-actions">
    ...
    <button type="button" class="ds-btn" onclick="window.__smpGrid?.downloadExcel()">엑셀 다운</button>
  </div>
</form>
    ...
    <form class="smp-pane" id="smpForm">
      <div class="smp-sec">
        ...
        <div class="smp-grid">
          ...
          <div class="smp-f">
            <label>연락처</label>
            <input data-phone type="text" id="smpMobile" class="form-control" maxlength="30" placeholder="010-0000-0000">
          </div>
          <div class="smp-f">
            <label>우편번호</label>
...
(function () {
  ...
  $('smpForm').addEventListener('submit', async (e) => {
    ...
    try {
      ...
      ceAlert('저장하지 못했습니다: ' + err.message, { tone: 'danger' });
      btn.disabled = false;
      btn.textContent = '저장';
    }
  });
