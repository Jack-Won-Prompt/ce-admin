...
<div class="card" id="mainCard">
  ...
  <div class="card-body">
    ...
    <div class="doc-list" id="docList">
      ...
      {{-- 확인할 서류가 하나도 없는 건 — 개인정보 동의를 이미 받았고 위임ㆍ청구ㆍ등록도
           해당하지 않는다(자동차보험ㆍ산재 따위). 빈 자리를 그대로 두면 무엇을 하러
           온 화면인지 알 수 없다. --}}
      @if(empty($_docs))
        <div class="doc-item"><div class="doc-note" style="border:none;padding:13px;">
          이 건에서 따로 확인하실 서류가 없습니다. 아래에 서명해 주시면 담당자가
          이어서 처리합니다.
        </div></div>
      @endif
    ...
    <div class="sig-section" id="privacyBlock">
      ...
      <div class="pv-card" id="pvInfo">
        ...
        <div class="pv-field" data-only="catheter">
          ...
          <div class="agree-radios">
            @foreach(['일반', '보훈', '산업재해', '자동차보험', '해당 없음(처방외)'] as $i => $v)
