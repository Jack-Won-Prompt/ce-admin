...
@section('content')
  ...
  <div id="pnlDetail" style="display:none;">
    ...
    <iframe id="pnlFrame" title="발송/발행 상세" style="display:none;width:100%;height:calc(100vh - 210px);border:1px solid var(--border);border-radius:8px;background:#fff;"></iframe>
  </div>
...
(function () {
  ...
  document.getElementById('dispatchGrid').addEventListener('dblclick', function (e) {
    ...
    frame.src = DETAIL_BASE + '/' + TYPE + '/' + row.id + '?embed=1';
