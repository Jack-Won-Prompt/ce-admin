  ...
  <div class="modal-box">
    ...
    <div class="modal-body">
      ...
      <div class="form-grid-2" style="margin-bottom:8px;">
        ...
        <div class="form-group">
          <label class="form-label">환자 전화번호</label>
        ...
        <div class="form-group">
          <label class="form-label">보호자 전화번호</label>
          <input type="text" class="form-control" id="add-phone" placeholder="02-XXXX-XXXX" data-phone />
        </div>
        <div class="form-group">
          {{-- 먼저 거는 번호는 하나다. 두 칸에 표를 두면 둘 다 켜지는 일을 막느라
               손이 더 가고, 「정하지 않음」으로 되돌리기도 번거롭다 — 한 칸에서 고른다. --}}
          <label class="form-label">Main contact</label>
          <select class="form-control" id="add-main-contact">
            <option value="">선택</option>
            <option value="mobile">환자</option>
...
(function () {
  ...
  document.getElementById('add-deduction')?.addEventListener('change', function () {
    addCashReceiptRule(this, 'add-cash-receipt', 'add-mobile');
  });
})();
</script>
@endpush
