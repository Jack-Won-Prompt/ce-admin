...
<div class="ds-grid-card">
  ...
  <div class="pnl-tabs" style="flex-wrap:wrap;">
    ...
    <div style="margin-left:auto;padding-right:12px;flex-shrink:0;">
      {{-- 항목 설정 (2026-09-22 확인요청 1쪽) — 이 표에서 볼 칸을 고른다.
           칸이 예순이 넘어 가로로 한참 밀어야 제 칸에 닿았다. 머리줄을 끌면 너비와
           자리가 바뀌고, 이 창에서는 「본다ㆍ안 본다」를 고른다. 머리줄을 오른쪽으로
           눌러도 같은 창이 열린다. --}}
      <button type="button" class="ds-btn" title="표에 표시할 항목을 선택합니다"
              onclick="window.__financeGrid?.openColumnSettings(this)">항목 설정</button>
