      ...
      <div class="ds-grid-bar">
        <div class="ds-grid-bar-left">
          ...
          <div class="sum-mini-row">
            @foreach([['NHIS 환급 확정', number_format($summary['nhis_reimb']).'원', 'var(--gray-800)'], ['배송비 합계', number_format($summary['shipping_fee']).'원', 'var(--gray-800)'], ['대기 중 주문', $statusCounts['pending'].'건', 'var(--gray-800)'], ['배송 완료', $statusCounts['delivered'].'건', 'var(--gray-800)']] as [$lbl, $val, $color])
            <div class="sum-mini">
