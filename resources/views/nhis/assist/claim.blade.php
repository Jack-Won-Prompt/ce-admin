...
<div class="sheet" id="sheet">
  ...
  {{-- 국세청자료 — 감춰 둔다 (2026-09-21 지시).

       대리점은 이 자리를 입력하지 않아도 되고, 공단 화면에서 카드결제를 더할
       수도 없다. 그런데 우리 창에 표가 서 있으면 담당자가 옮겨 적어야 하는
       자리로 읽는다. 표를 지우지 않고 감춰만 둔 것은, 공단이 이 자리를 다시
       요구할 때 되살리기 위해서다. --}}
  @php($국세청자료를_보인다 = false)
  @if($국세청자료를_보인다)
  <div class="sec">
