...
{{-- 상단 칩 대신 검색 필터에서 고른다. 칩이 한 줄을 통째로 차지하면서도
     ...
     (시안 282:53 은 칩줄을 그리지만 main 커밋 c99af13 의 제품 판단을 따른다.
      괄호 설명을 칩 안에 넣던 우리 수정도 칩과 함께 사라진다 — 디자이너 확인 대상.) --}}
...
<div class="ds-grid-section">
  <div class="ds-grid-bar">
    <div class="ds-grid-bar-left">
      ...
      {{-- 시안 282:53 결과바는 '이번달 청구액' 뒤에 콜론이 없다(같은 줄 '전체 N건'·'선택 N건'도 콜론이 없다) --}}
