  ...
  <div class="rto-sec">
    ...
    <div class="rto-filter">
      ...
      <div class="rto-fld"><label>전화번호</label>
        <input data-phone type="text" id="rtoPhone" class="form-control" maxlength="20" placeholder="010-0000-0000"></div>
      <div class="rto-fld wide"><label>주문번호</label>
        <input type="text" id="rtoNo" class="form-control" maxlength="50" placeholder="주문번호 · 위드웍스 판매번호"></div>
