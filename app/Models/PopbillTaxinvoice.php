...
class PopbillTaxinvoice extends Model
{
    ...
    /**
     * 상태 코드 → 글.  **팝빌 공식 표 그대로다** (2026-09-24 확인).
     * https://developers.popbill.com/api-reference/taxinvoice/response-code
     *
     * 여태 적어 둔 말이 공식과 달랐다 — 300 을 「국세청대기」, 600 을 「국세청취소」라
     * 적었고 **304 는 아예 없어 화면에 숫자가 그대로 떴다**(운영에 서른다섯 건).
     * 600 은 국세청이 아니라 **공급자가 발행을 취소한 것**이라, 그렇게 읽으면
     * 누가 취소했는지를 거꾸로 안다.
     */
