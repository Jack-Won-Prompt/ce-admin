...
class Order extends Model
{
    ...
    /**
     * 목록에 적는 말 (2026-09-15 지시).
     *
     * 여태는 추가 주문에만 적고 나머지는 비워 두었다 — 거의 다 원 주문이라 칸이
     * 어지러워진다는 까닭이었다. 그런데 빈칸은 「아직 안 정해졌다」로도 읽혀,
     * 담당자가 이 주문이 무엇인지 칸만 보고는 알 수 없었다.
     *
     * 이제 둘 다 적는다. 처방전으로 시작한 첫 주문도, 처방전 없이 시작한 주문도
     * 담당자에게는 「신규 주문」이다 — 그 뒤에 더 사는 것이 「추가 주문」이다.
     */
