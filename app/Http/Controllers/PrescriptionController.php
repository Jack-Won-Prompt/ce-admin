...
class PrescriptionController extends Controller
{
    ...
    public function updateWithworksOrder(Request $request, Prescription $prescription): \Illuminate\Http\JsonResponse
    {
        ...
        /* 정정을 막는 잣대는 **모두 화면에 있다** (2026-09-25).

           여기서 막으면 안 된다. 화면은 정정할 때 ① 로컬 저장(여기서 결제가 물리고
           재결제 링크가 나간다) → ② 창고 연계 차례로 부른다. 그래서 이 자리에 올
           때는 이미 「재결제 대기」이고 「품목도 같다」 — 두 잣대 모두 **정상 정정의
           둘째 걸음을 잡아먹는다**. 실제로 그렇게 창고만 옛 수량으로 남았다.

           막을 것은 **첫 걸음을 떼기 전에** 막아야 한다. 그 자리를 아는 것은 화면뿐이다. */
