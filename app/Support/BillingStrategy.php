...
class BillingStrategy
{
    ...
    public static function resolve(?string $accAddType, ?string $benefitClass): array
    {
        ...
        /* 발행 규칙(2026-08-24 확정 · 08-31 다듬음).
           ...
           본인부담이 섞여 있는 일반(10/90)도 그 10% 몫의 증빙을 낸다 (2026-09-19 지시).
           여태는 세금계산서 90% 하나로 끝냈는데, 그러면 환자가 제 돈으로 낸 10% 에
           증빙이 아무것도 남지 않는 길이 있었다 — 카드로 받으면 매출전표가 붙지만
           가상계좌ㆍ무통장으로 받으면 아무것도 없었다.

           카드로 받은 건에 현금영수증이 겹쳐 나가는 일은 없다. 발행하는 자리
           (DepositAutoIssue::cashReceipt)가 가상계좌ㆍ무통장일 때만 내기 때문이다 —
           카드는 매출전표가 그 자리의 증빙이고, 둘 다 내면 같은 금액이 두 번 신고된다. */
